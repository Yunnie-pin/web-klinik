<template>
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="modal-body relative p-4">
                              Apakah anda yakin ingin memproses Pemeriksaan?
                            </div>
                            <div
  ...
  export default {
    ...
    created() {
      // Get Bidang
      axios
        .get(API_URL + "api/pemeriksaan/" + this.$route.params.id)
        .then((response) => {
