                            ...
                            <div class="py-3">
                              <div class="py-0.5">
                                ...
                                <select
                                  class="form-select appearance-none border-1 border-gray-400 w-full px-2 py-2 self-center rounded-lg bg-[#DBDBDB] drop-shadow-sm"
                                  aria-label="Default select example"
                                  v-model="patient.jenis_identitas"
                                >
                              ...
                              <div class="py-0.5">
                                ...
                                <input
                                  ...
                                  aria-label="nomeridentitas"
                                  id="nomeridentitas"
                                  v-model="patient.no_identitas"
                                />
                              </div>
                              ...
                              <div class="py-0.5">
                                ...
                                <input
                                  type="text"
                                  class="border-1 border-gray-400 w-full px-2 py-2 self-center rounded-lg bg-[#DBDBDB] drop-shadow-sm"
                                  placeholder="Nomer BPJS"
                                  aria-label="nomerbpjs"
                                  id="nomerbpjs"
                                  v-model="patient.bpjs"
                                />
                                <div
                                  class="text-black-700 font-bold text-xs py-1"
                                >
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="modal-body relative p-4">
                            Apakah anda yakin ingin memperbaharui Pasien?
                          </div>
                          <div
                            ...
                            <button
                              ...
                              v-on:click="
                                submitForm(
                                  patient.id,
                                  patient.nama,
                                  patient.tanggalLahirPatient,
                                  patient.jenisKelaminPatient,
                                  patient.noTelpPatient,
                                  patient.alamat,
                                  patient.jenisIdentitasPatient,
                                  patient.noIdentitasPatient,
                                  patient.bpjs
                                )
                              "
                            >
    ...
    axios
      ...
      .then((response) => {
        ...
        this.patient = {
          ...
          tanggal_lahir: this.form.data.tanggal_lahir,
          jenis_kelamin: this.form.data.jenis_kelamin,
          no_telp: this.form.data.no_telp,
          alamat: this.form.data.alamat,
          jenis_identitas: this.form.data.jenis_identitas,
    ...
    submitForm(
      ...
      axios
        .put(API_URL+"api/pasien", {
          ...
          jenis_kelamin: jenisKelaminPatient,
          no_telp: noTelpPatient,
          alamat: alamatPatient,
          jenis_identitas: jenisIdentitasPatient,
          no_identitas: noIdentitasPatient,
          bpjs: bpjsPatient,
        })
        .then((res) => {
