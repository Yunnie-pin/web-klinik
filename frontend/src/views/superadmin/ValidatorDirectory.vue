                  ...
                  <tbody>
                    <tr v-for="validator of validator.data" :key="validator.id">
                      ...
                      <td
                        class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"
                      >
                        <div v-if="validator.status == 1">aktif</div>
                        <div v-if="validator.status == 0">tidak aktif</div>
                      </td>
                      <td
                        class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"
                      >
                ...
                <div class="modal-dialog relative w-auto pointer-events-none">
                  ...
                  >
                    ...
                    <div class="modal-body relative p-4">
                      Apakah anda yakin ingin memperbaharui data Validator?
                    </div>
                    <div
                    ...
                    >
                      ...
                      <router-link
                        :to="{
                          path: '/superadmin/update-validator/' + targetIdModal,
                        }"
                      >
                        <button
                          type="button"
              ...
              >
                <div class="modal-dialog relative w-auto pointer-events-none">
                  ...
                  >
                    ...
                    <div class="modal-body relative p-4">
                      Apakah anda yakin ingin menghapus data Validator?
                    </div>
                    <div
                      class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t border-gray-200 rounded-b-md"
                    >
