                            ...
                            <div class="flex-auto p-4">
                              ...
                              <div class="py-3">
                                ...
                                >
                                  ...
                                  <option value="Hematodologi">Hematodologi</option>
                                  <option value="Bakteriologi dan Parasitologo">Bakteriologi dan Parasitologo</option>
                                </select>
                              </div>
                              </div>
                            </div>
                              ...
                              <div class="py-7">
                                <div class="py-0.5">
                                  ...
                                  >
                                    ...
                                    <option value="hematologi analyzer">hematologi analyzer</option>
                                    <option value="westergren">westergren</option>
